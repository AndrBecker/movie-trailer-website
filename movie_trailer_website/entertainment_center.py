# This python script creates the media.Movie objects describing the favourite movies
# and calls fresh_tomatoes open_movies_page with the list of the movie objects
# ( which generates the fresh_tomatoes.html file and opens it in a webbrowser).
...
onceupon = media.Movie("Once Upon a Time in the West",
...
fitzcarraldo= media.Movie("Fitzcarraldo",
                                        "Opera-crazed eccentric struggling to build an opera in the Amazonian jungle",
...
discreetcharm= media.Movie("The Discreet Charm of the Bourgeoisie",
                                            "Surrealistic classic about a group of people repeatedly trying in vain to dine together",
...
apocalypsenow= media.Movie("Apocalypse Now",
                                            "US special agent sent on mission to Vietnam to kill renegade and presumed insane US colonel",
...
movies = [avatar, fitzcarraldo, eraserhead, onceupon, discreetcharm, apocalypsenow ]
